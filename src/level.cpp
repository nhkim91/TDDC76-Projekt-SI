...
flying_objects* level::get_alien_mk1()
{
    ...
    alien_mk1 alien(data[0], data[1], data[2], data[3], data[4], renderer);
...
flying_objects* level::get_alien_mk2()
{
    ...
    alien_mk2 alien(data[0], data[1], data[2], data[3], data[4], renderer);
...
flying_objects* level::get_alien_mk3()
{
    ...
    alien_mk3 alien(data[0], data[1], data[2], data[3], data[4], renderer);
...
flying_objects* level::get_meteorite_small()
{
    ...
    meteorite_small meteorite{data[0], data[1], data[2], data[3], data[4], renderer};
...
flying_objects* level::get_meteorite_medium()
{
    ...
    meteorite_medium meteorite{data[0], data[1], data[2], data[3], data[4], renderer};
...
flying_objects* level::get_power_up(int i)
{
    ...
    if(i < 320)
    {
        power_up_attack power_up{data[0], data[1], data[2], data[3], data[4], renderer};
        flying_objects* attack = static_cast<flying_objects*>(&power_up);
        return attack;
    }
    else if(i >= 320 && i < 340)
    {
        power_up_life power_up{data[0], data[1], data[2], data[3], data[4], renderer};
        flying_objects* life = static_cast<flying_objects*>(&power_up);
        return life;
    }
    else
    {
        power_up_shield power_up{data[0], data[1], data[2], data[3], data[4], renderer};
